...
public class LT03_ExMat00 {
    public static void main(String[] args){
        ...
        for(double[] aluno : notas){
            int cont = 0;
            System.out.println("");// exibir qual aluno esta lendo
        ...
        for(double media : mediaAlunos){
            ...
            System.out.printf("A media do aluno eh %.2f %n",media);// exibir qual aluno esta lendo
        }


        System.out.printf("A media da prova 1  eh %.2f%n", mediaProvas[0]/3);
        System.out.printf("A media da prova 2 eh %.2f%n", mediaProvas[1]/3);
